...
$query1 = 'SELECT * FROM employees.employees';
$sth = $dbh->query($query1); // Total # of records
...
$query = 'SELECT * FROM employees.employees ORDER BY emp_no LIMIT :page, :totalResults';
